...
})({"18WW8":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a7a22012e102d921";
"use strict";
...
},{}],"ex3xX":[function(require,module,exports) {
...
document.addEventListener("scroll", (event)=>{
    if (window.scrollY > 50) navMini.classList.replace("nav-bar--default", "nav-bar--mini");
    else navMini.classList.replace("nav-bar--mini", "nav-bar--default");
});
...
function dropDown() {
    ...
    if (elementDropDown.classList[1] == "--visible") main.addEventListener("click", dropDown);
    //Needed so when exit button is pressed to removes event from main
    if (elementDropDown.classList[1] == "--hidden") main.removeEventListener("click", dropDown);
}
/*
...
},{}]},["18WW8"], null, "parcelRequirec8c2")

//# sourceMappingURL=nav-bar_script.e102d921.js.map
