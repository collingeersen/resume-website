...
class $153d73be08e6eb0b$var$projectsComp extends HTMLElement {
    constructor(){
        ...
        this.shadowRoot.append($153d73be08e6eb0b$var$projectsComp.template.content.cloneNode(true));
    }
}
//Attaching through template so HTML is readily available for reuse on page 
$153d73be08e6eb0b$var$projectsComp.template = document.createElement("template");
...
customElements.define("projects-comp", $153d73be08e6eb0b$var$projectsComp);
